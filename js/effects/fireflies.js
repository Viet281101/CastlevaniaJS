...
class Firefly {
  ...
  move() {
    ...
    if (this.x < 0 || this.x > w - 10) {
      this.and = Math.PI - this.and;
    }
    if (this.y < 0 || this.y > h - 10) {
      this.and = -this.and;
    }
  ...
  show() {
    ...
    if (
      this.x > influenceArea.x &&
      this.x < influenceArea.x + influenceArea.width &&
      this.y > influenceArea.y &&
      this.y < influenceArea.y + influenceArea.height
    ) {

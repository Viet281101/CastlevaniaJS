window.addEventListener('load', (event) => {
  ...
  assets_manager.requestJSON(ZONE_PREFIX + game.world.zone_id + ZONE_SUFFIX, (zone) => {
    ...
    assets_manager.requestImage(
      'assets/Decorations/Animated Decorations/torch_big/torch_big_bg.png',
      (image) => {
        assets_manager.torch_image = image;
      }
    );
    assets_manager.requestImage('assets/Characters/Skull/fire_skull.png', (image) => {
      assets_manager.fire_skull_image = image;
    });
    assets_manager.requestImage('assets/Characters/Skull/dark_skull.png', (image) => {
      assets_manager.dark_skull_image = image;
    });
    assets_manager.requestImage('assets/Characters/Nightmare/nightmare.png', (image) => {
      assets_manager.nightmare_image = image;
    });
    assets_manager.requestImage('assets/Characters/Ghost/ghost_sheet.png', (image) => {
